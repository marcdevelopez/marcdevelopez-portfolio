...
Copyright (c) 2025 Marc García (marcdevelopez.com) and the ShuttleBiz Team.  
All rights reserved.
...
- You may not copy, modify, redistribute, publish, or reuse this code in any form.
- You may not create derivative or commercial works based on this project.
- You may not fork or replicate this project independently.
- All collaboration must occur within official repositories or communication channels approved by the ShuttleBiz Team.

## 4. **INTELLECTUAL PROPERTY**

All intellectual property rights to the code, design, and related materials belong to Marcos García and Ezequiel Coeli.  
...
Email: [contacto@marcdevelopez.com](mailto:contacto@marcdevelopez.com)  
Website: [ShuttleBiz License](https://marcdevelopez.com/shuttlebiz-license)
